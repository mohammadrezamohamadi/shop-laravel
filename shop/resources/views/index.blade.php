    ...
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="#pablo">
                <img src="{{ asset('img/logo.png')}}" height="24px" alt="">
            </a>
            ...
            <div class="search-nav default">
                <form action="">
                    ...
                    <button type="submit"><img src="{{ asset('img/search.png')}}" alt=""></button>
                </form>
                <ul>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <div class="logo-nav-res default text-center">
                <a href="#">
                    <img src="{{ asset('img/logo.png') }}" height="36px" alt="">
                </a>
            </div>
                ...
                <div class="col-12">
                    <div class="brand-slider card">
                        ...
                        <div class="owl-carousel">
                            <div class="item">
                                <a href="#">
                                    <img src="img/brand/1076.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/brand/1078.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/brand/1080.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/brand/2315.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="img/brand/5189.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="info">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 text-center">
                        <a href="#" target="_blank"><img src="img/bazzar.png" width="159" height="48"
                                                         alt=""></a>
                        <a href="#" target="_blank"><img src="img/sibapp.png" width="159" height="48"
                                                         alt=""></a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="symbol col-12 col-lg-5">
                        <a href="#" target="_blank"><img src="img/symbol-01.png" alt=""></a>
                        <a href="#" target="_blank"><img src="img/symbol-02.png" alt=""></a>
                    </div>
                    <div class="col-12">
                        <div class="row">
